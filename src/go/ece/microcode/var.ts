...
function evaluate_var(cmd: number, heap: Heap, C: Control, S: Stash, E: Env): void {
...
function evaluate_var_i(cmd: number, heap: Heap, C: Control, S: Stash, E: Env): void {
...
function evaluate_name(cmd: number, heap: Heap, C: Control, S: Stash, E: Env): void {
...
function evaluate_assign(cmd: number, heap: Heap, C: Control, S: Stash, E: Env): void {
...
function evaluate_assign_i(cmd: number, heap: Heap, C: Control, S: Stash, E: Env): void {
